...
<div id="bg-img"></div>
    ...
    <div id="bg-section">
        ...
        <div class="content two">
            ...
            <p class="announcement">Summer vacation July 2-6</p>
            <p class="announcement">No classes in Hartford, Fredonia, or Brookfield</p>
            <p class="announcement">Happy 4th of July</p>
            
            <br>
        
            <p class="announcement"><strong>IMPORTANT: TEAM MEMBERS ONLY</strong> - Any team members wanting to travel to Chicago for cross training with Master Godoy, Master Javiar, and Master May</p>

                <p class="announcement">Date: TBA, 2018</p>

                <p class="announcement">Time: We leave at 7:15 sharp from McDonalds </p>

                <p class="announcement">Cross training starting at 10am</p>

                <p class="announcement">Address: 3944 W. 63rd St. Chicago, IL 60627</p>

                <p class="announcement">Other schools will be joining us also</p>
        ...
        <div class="content two">
            ...
            <h1>JOIN THE ATKD TEAM</h1>
            
            <p>Are you or someone you know interested in learning martial arts?  American Taekwondo has several locations to choose from with our newest location in Brookfield.  If you're interested in learning more about our programs don't hesitate to call or simply submit the form below.</p>
            
            <div id="form" action="index.php">
